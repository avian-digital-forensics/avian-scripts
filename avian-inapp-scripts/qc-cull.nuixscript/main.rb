...
if dialog.dialog_result
    ...
    ProgressDialog.for_block do |progress_dialog|
        ...
        Utils::bulk_add_tag(utilities, progress_dialog, timer, selected_item_tag, items)
        ...
        Utils::bulk_remove_tag(utilities, progress_dialog, timer, selected_item_tag, items)
